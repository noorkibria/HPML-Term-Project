...
[13] Ahmed, S., et al. (2024). A sustainable neuromorphic framework for disease diagnosis using digital medical imaging (Computer Methods and Programs in Biomedicine Update).
...
[14] Fang, Y., et al. (2025). A fast and accurate ANN–SNN conversion algorithm with negative spikes (International Joint Conference on Artificial Intelligence).
...
[15] Rueckauer, B., Lungu, I.‑A., Hu, Y., Pfeiffer, M., & Liu, S.‑C. (2017). Conversion of continuous‑valued deep networks to efficient event‑driven networks for image classification (Frontiers in Neuroscience 11).
...
[16] Cao, Y., Chen, Y., & Khosla, D. (2015). Spiking deep convolutional neural networks for energy‑efficient object recognition (International Journal of Computer Vision).
...
[17] Patankar, M., Chaurasia, V., & Shandilya, M. (2025). A novel spiking neural network method for classification of tuberculosis using X‑ray images (Computers & Electrical Engineering 122).
...
[18] Kumar, K. A., et al. (2025). A hybrid parallel convolutional spiking neural network for enhanced skin cancer detection (Scientific Reports).
...
[19] Khan, A., et al. (2025). Review of deep learning models with spiking neural networks for modeling and analysis of multimodal neuroimaging data (Frontiers in Neuroscience).
...
[20] Garcia‑Palencia, O., et al. (2025). Spiking neural networks for multimodal neuroimaging: a comprehensive review of current trends and the NeuCube brain‑inspired architecture (Bioengineering).
...
[21] Shen, H., et al. (2024). Rethinking the membrane dynamics and optimization objectives in spiking neural networks (Neural Information Processing Systems).
...
[22] Niu, L.‑Y., Wei, Y., Liu, W.‑B., Long, J.‑Y., & Xue, T.‑H. (2023). Research progress of spiking neural network in image classification: a review (Applied Intelligence 53, 19466–19490).
...
[23] Kheradpisheh, S. R., Ganjtabesh, M., Thorpe, S. J., & Masquelier, T. (2018). STDP‑based spiking deep convolutional neural networks for object recognition (Neural Networks 99, 56–67).
...
[24] Yu, Q., et al. (2021). Constructing deep spiking neural networks from artificial neural networks with knowledge distillation (AAAI Conference on Artificial Intelligence).
...
[25] Cao, L., et al. (2025). A novel spiking neural network method for classification of tuberculosis using X‑ray images (Computers & Electrical Engineering 122).
URL: https://doi.org/10.1016/j.compeleceng.2024.108044
